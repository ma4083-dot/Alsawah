...
const CACHE_NAME   = 'alsawah-v5-5';
const FONT_CACHE   = 'alsawah-fonts-v1';
const STATIC_CACHE = 'alsawah-static-v5-5';
...
self.addEventListener('fetch', event => {
    ...
    // ── 2. الفونتات — Cache First (تدوم طويلاً) ──
    ...
    // ── 4. الملف الرئيسي index.html — Network First مع Fallback ──
    ...
    // ── 5. باقي الطلبات من نفس الأصل — Cache First ──
...
console.log('[SW] 📦 Alsawah Lab Service Worker جاهز —', CACHE_NAME);
